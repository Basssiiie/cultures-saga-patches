...
#
		...
		# Increase message timeout to from 3 to 7 seconds to survive more temporary hiccups
		exe.verify_and_replace(0xdd013, [ 0x68, 0xb8, 0x0b, 0x00, 0x00 ], [ 0x68, 0x58, 0x1b, 0x00, 0x00 ])
